...
<div class="wrapper fadeInDown">
    <div id="formContent">
        ...
        <form method="POST" action="{{ route('login') }}">
            @csrf
            <input id="username" type="username" class="fadeIn second @error('username') is-invalid @enderror" name="username" value="{{ old('username') }}" required autocomplete="username" autofocus placeholder="username">
            @error('username')
