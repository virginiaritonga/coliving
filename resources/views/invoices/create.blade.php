...
<div class="col-xl-12">
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h5 class="m-0 font-weight-bold text-primary">Create Invoice </h5>
        </div>
        <div class="card-body">
            <div class="row">
                {{-- booking --}}
                ...
                <div class="col-xl-12">
                    ...
                    @endif
                    <form method="POST" id="form" action="{{route('invoice.store',$bookings->id)}}">
                        @csrf
                        <div class="form-group">
                            <label for="booking_id">Booking ID</label>
                            <input type="text" name="booking_id" id="booking_id" class="form-control" value="{{$bookings->id}}" {{$errors->has('booking_id') ? 'is-invalid' : ''}} disabled>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="number" min="0" name="discount" value="0" id="discount" class="form-control"  {{$errors->has('discount') ? 'is-invalid' : ''}} onkeyup="total()">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="number" min="0" value="0" name="additional_cost" id="additional_cost" class="form-control" {{$errors->has('additional_cost') ? 'is-invalid' : ''}} onkeyup="total()">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="number" min="0" name="total_payment" id="total_payment" class="form-control" value="{{$subtotal_room}}" {{$errors->has('total_payment') ? 'is-invalid' : ''}} disabled>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="is_paid" id="is_paid" {{$errors->has('is_paid') ? 'is-invalid' : ''}} >
